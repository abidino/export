...
public class CustomerExportService {
    ...
    public String exportExcel() {
        ...
        do {
            Page<CustomerEntity> pageableCustomerEntities = customerRepository.findAll(pageable);
            page = CustomerMapper.createCustomerFromCustomerEntity(pageableCustomerEntities);
        ...
        FileUtil.convertByteArrayOutputStreamToFile(outputStream, FileUtil.createFileName("customer", ".xlsx"));
    ...
    public String exportCsv() {
        ...
        FileUtil.convertByteArrayOutputStreamToFile(outputStream, FileUtil.createFileName("customer", ".csv"));
        return FileUtil.convertToBase64(outputStream);
    }
}
